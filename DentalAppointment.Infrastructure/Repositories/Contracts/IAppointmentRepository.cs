...
namespace DentalAppointment.Infrastructure.Repositories.Contracts
{
    public interface IAppointmentRepository : IGenericRepository<AppointmentModel>
    {
        ...
        Task<AppointmentModel> UpdateAppointmentAsync(DateTime actualAppointmentDateTime, DateTime? newAppointmentDateTime, string patientName, string patientPhoneNumber, TreatmentType treatmentType, string notes);
